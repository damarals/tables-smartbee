...
tibble(
  ...
  `Use Gráficos Quando` = c(
    "* Será usada para revelar as relações entre conjuntos inteiros de valores",
    "* A mensagem está contida na forma dos valores (por exemplo, padrões, tendências, exceções)",
    "",
    "",
    ""
  )
  ...
  tab_source_note(
    md("Adaptado de:<br>Few, Stephen. (2012). *Show Me the Numbers: Designing Tables and Graphs to Enlighten*.(4)57")
  ) |> 
...
tibble(
  `Primary Function` = c("Olhe", "", "", "Compare", ""),
  `Relationship Type` = c("Quantitativa-vs-Categórica", "", "", "Quantitativa-vs-Quantitativa", ""),
  Relationship = c ("Entre um **único** conjunto de valores quantitativos e um **único conjunto de itens categóricos**",
                    "Entre um **único** conjunto de valores quantitativos e a **interseção de várias categorias**",
                    "Entre um **único** conjunto de valores quantitativos e a **interseção de várias categorias hierárquicas**",
                    "Entre um **único** conjunto de valores quantitativos associados a **vários itens categóricos**",
                    "Entre conjuntos **distintos** de valores quantitativos associados a um **único item categórico**"),
  ...
  cols_label(
    `Primary Function` = "Função Primária",
